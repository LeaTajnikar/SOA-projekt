...
# GraphQL Types
class ReservationType(ObjectType):
    username = String()
    book_title = String()
...
class Query(ObjectType):
    ...
    reservations = List(ReservationType, username=String(), book_title=String())
...
class Mutation(ObjectType):
    ...
    add_reservation = Field(ReservationType, username=String(), book_title=String())
